...
save_path = '/home/joel/PycharmProjects/DeepBCI/code/Ind_BCImodel_noprep_singlekernel.pt'
...
var_save_path = '/home/joel/PycharmProjects/DeepBCI/results/Ind_results_62chan_noprep_singlekernel.tar'  # type: str
...
for i in subjs[-6:]:
    ...
    if not i == 100:
        ...
        for CV in np.arange(0, num_folds):
            ...
            model = ShallowFBCSPNet(split_first_layer=False, in_chans=in_chans, n_classes=n_classes,
            ...
            model.network.conv_time.kernel_size = (30, in_chans-10)
